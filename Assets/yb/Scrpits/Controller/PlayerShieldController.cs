...
namespace yb {
    public class PlayerShieldController : MonoBehaviour, ITakeDamage, ITakeDamagePhoton//0412 09:30 이희웅 포톤용 인터페이스 추가
    {
        ...
        private PhotonView _photonView; //0412 09:30 이희웅 포톤 뷰 추가

        public PhotonView IphotonView => _photonView;//0412 09:30 이희웅 포톤 뷰 추가
